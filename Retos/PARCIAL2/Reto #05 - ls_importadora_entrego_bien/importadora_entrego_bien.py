...
programa que se encargue de establecer el costo
...
for registro in arch:
    ...
    if costo >= 100:
        ...
        print("El producto %s tiene un pago por nacionalizacion de %.2f Bs. " % (descripcion, pago))
    else:
...
if (conelectronicos + electronicos) != 0:
    por = (electronicos / conelectronicos) * 100
